...
def insert_reporters(connection, name, email, phone_number, facebook, x):
    """
    ...
    """
    query = """
    INSERT INTO reporters (name, email, phone_number, facebook, x)
    VALUES (%s, %s,%s, %s,%s)
    """
    data = (name, email, phone_number, facebook, x)
    execute_query(connection, query, data)
